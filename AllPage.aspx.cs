...
namespace WebApplication1
{
    public partial class AllPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                #region 內容
                ((LinkButton)this.Master.FindControl("Lb_All")).BackColor = Color.White;
                ((LinkButton)this.Master.FindControl("Lb_All")).ForeColor = Color.Black;
                ((Label)this.Master.FindControl("Lb_Title")).Text = "所有公文及投票";
        ...
        private DataTable GetData()
        {
            ...
            string sqlstr = "Select Fil.Title,Fil.Type,Fil.DeadLine,Fil.Speed,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID = Detail.SID Where Detail.EID = '" + Lbl_EID.Text + "' and Fil.IsEnd='0' and Detail.look=1 order by SID desc";
        ...
        {
            dt = new DataTable();
            string sqlstr = "Select  Fil.Title,Fil.Type,Fil.DeadLine,Fil.Speed,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID=Detail.SID Where Detail.EID='" + Lbl_EID.Text + "' and Detail.look=1 and Fil.IsEnd='0' order by SID desc";
            SqlConnection sqlcon = new SqlConnection(tmpdbhelper.DB_CnStr);
            SqlCommand cmd = new SqlCommand(sqlstr, sqlcon);
            DataSet myds = new DataSet();
            sqlcon.Open();
        ...
        public void bind2()
        {
            ...
            string searchingstr = "Select  Fil.Title,Fil.Type,Fil.DeadLine,Fil.Speed,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID=Detail.SID Where Detail.EID=@EID and Fil.IsEnd='0' and Detail.look=1 ";

...
namespace WebApplication1
{
    public partial class Draft : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ((LinkButton)this.Master.FindControl("Lb_Draft")).BackColor = Color.White;
                ((LinkButton)this.Master.FindControl("Lb_Draft")).ForeColor = Color.Black;
                ((Label)this.Master.FindControl("Lb_Title")).Text = "草稿";

<%@ Page Title="" Language="C#" MasterPageFile="~/GuildPage.Master" AutoEventWireup="true" CodeBehind="DraftDetail.aspx.cs" Inherits="WebApplication1.DraftDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr style="height: 25px">
            <td>說　　明</td>
            <td colspan="6">
                <CKEditor:CKEditorControl ID="Txt_Text" runat="server">

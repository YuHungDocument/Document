...
{
    public partial class EndDocument : System.Web.UI.Page
    {
        int index = 1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ((Label)this.Master.FindControl("Lb_Title")).Text = "已結案公文";
        ...
        private DataTable GetData()
        {
            ...
            string sqlstr = "Select Fil.Title,Fil.Type,Fil.Speed,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID = Detail.SID Where Detail.EID = '" + Lbl_EID.Text + "' and Fil.Type != '投票' and Fil.IsEnd = '1' order by SID desc";
        ...
        public void bind2()
        {
            ...
            string searchingstr = "Select Fil.Title,Fil.Type,Fil.Speed,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID = Detail.SID Where Detail.EID = '" + Lbl_EID.Text + "' and Fil.Type != '投票' and Fil.IsEnd = '1'";

...
{
    public partial class EndVote : System.Web.UI.Page
    {
        int index = 1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    ((LinkButton)this.Master.FindControl("Lb_End")).BackColor = Color.White;
                    ((LinkButton)this.Master.FindControl("Lb_End")).ForeColor = Color.Black;
                    ((Label)this.Master.FindControl("Lb_Title")).Text = "已結束投票";
        ...
        private DataTable GetData()
        {
            ...
            string sqlstr = "Select Fil.Title,Fil.DeadLine,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID = Detail.SID Where Detail.EID = '" + Lbl_EID.Text + "' and Detail.look = '1' and Fil.Type = '投票' and (Fil.IsEnd='1' or DeadLine<Getdate()) order by SID desc";
        ...
        public void bind2()
        {
            ...
            string searchingstr = "Select Fil.Title,Fil.DeadLine,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID=Detail.SID Where Detail.EID=@EID and Detail.look='1' and (Fil.IsEnd='1' or DeadLine<Getdate()) and Detail.sign='0' and Fil.Type='投票'";
        ...
        {
            Response.Redirect("EndVote.aspx");
        }
    }
}
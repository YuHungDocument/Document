...
namespace WebApplication1
{
    public partial class EndVote : System.Web.UI.Page
    {
        ...
        private DataTable GetData()
        {
            ...
            string sqlstr = "Select Fil.Title,Fil.DeadLine,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID = Detail.SID Where Detail.EID = '" + Lbl_EID.Text + "' and Detail.look = 1 and Fil.Type = '投票' and DeadLine<Getdate() order by SID desc";
        ...
        public void bind2()
        {
            ...
            string searchingstr = "Select Fil.Title,Fil.DeadLine,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID=Detail.SID Where Detail.EID=@EID and Detail.look=1 and DeadLine<Getdate() and Detail.sign=0 and Fil.Type='投票'";

...
namespace WebApplication1
{
    public partial class WaitDocument : System.Web.UI.Page
    {
        ...
        private DataTable GetData()
        {
            ...
            string sqlstr = "Select Fil.Title,Fil.Type,Fil.Speed,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID = Detail.SID Where Detail.EID = '" + Lbl_EID.Text + "' and Detail.look = 1 and (Detail.sign = 0 or Detail.isread = 0) and Fil.Type != '投票' order by SID desc";
        ...
        public void bind2()
        {
            ...
            string searchingstr = "Select  Fil.Title,Fil.Type,Fil.Speed,Fil.Date,Fil.SID From Fil Left join Detail On Fil.SID=Detail.SID Where Detail.EID=@EID and Detail.look=1 and (Detail.sign=0 or isread=0) and Fil.Type!='投票'";

        ...
        protected void Btn_Save_Click(object sender, EventArgs e)
        {
                ...
                )
            {
                using (SqlConnection cn2 = new SqlConnection(tmpdbhelper.DB_CnStr))
                {
                    ...
                    SqlCommand cmd3 = new SqlCommand(@"Insert INTO Fil(SID,EID,Date,DeadLine,Text,Title,Proposition,Type,YOS,AESkey,AESiv,txt_RSAhash_Text,txt_RSAhash_Proposition)VALUES(@SID,@EID,@Date,@DeadLine,@Text,@Title,@Proposition,@Type,@YOS,@AESkey,@AESiv,@txt_RSAhash_Text,@txt_RSAhash_Proposition)");
                    cn2.Open();
                    cmd3.Connection = cn2;
                    //cmd4.Connection = cn2;
                    //建立一個 AES 演算法
